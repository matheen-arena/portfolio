...
- **Missions**: each project as a round, embroidered-style mission patch that flips (hover, tap or Enter) to show its outcomes.
...
- **Missions**, **Work log** and **Stack graph** content lives in `content/missions.md`, `content/worklog.md` and `content/stack.md`. See [`content/USAGE.md`](content/USAGE.md) for the format.
- Other text (about, contact) is in `index.html`.
